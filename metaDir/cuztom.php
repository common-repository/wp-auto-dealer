...
class Cuztom_Initializer
{
	...
	private function includes()
	{
		...
		include( CUZTOM_DIR . 'classes/fields/carYear.class.php' );
	...
	function register_scripts()
	{
		...
		wp_register_script( 'carAPI', 	CUZTOM_URL . '/assets/js/carReady.js', 	array( 'jquery' ), CUZTOM_VERSION, true );
		wp_register_script( 'carBase', 	'http://www.carqueryapi.com/js/carquery.0.3.4.js', 	array( 'jquery' ), CUZTOM_VERSION, true );
		wp_register_script( 'carquery-api-js', get_plugin_url ().'/metaDir/assets/js/carAPI.js', array(), '1.0.0', true );
		wp_register_script( 'car-ready', get_plugin_url ().'/metaDir/assets/js/carReady.js', array(), '1.0.0', true );
	}
	...
	function enqueue_scripts()
	{
		...
		$single = $_GET['action'];
		if( (get_post_type() == 'wp_car' ) && ($single == 'edit')) {
		wp_enqueue_script( 'carquery-api-js' );
		wp_enqueue_script( 'car-ready' );
